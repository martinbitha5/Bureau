...
if (E) {
  ...
  // Si les propriétés sont non-configurables, on substitue une sous-classe dont les
  // constantes sont modifiables (event-target-shim étend Event et hérite alors d'une
  // propriété writable, ce qui permet l'assignation).
  if (needsReplace) {
